    ...
    return (
        <div className="mt-5 md:py-16 px-4 md:px-10 bg-black text-white">
            ...
            <div className="text-center mb-12">
                <img src="/assets/benefits.svg" alt="Benefits" className="mx-auto mb-4" />
