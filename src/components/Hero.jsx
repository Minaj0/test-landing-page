    ...
    return (
        <div className='items-center flex flex-col justify-center container mx-auto'>
            ...
            <div className="rating">
                <p className='flex gap-2 items-center justify-center border-1 rounded-4xl mt-16 px-5 py-1 text-[#a6a6a6] bg-primary2 border-[#313131]'>5.0 <img src="src/assets/Container.svg" alt="" />11 reviews</p>
            </div>
            {/* heading */}
            ...
            {/* button */}
            <img src="src/assets/connectUs.svg" className='mt-6' alt="" />
            {/* cards */}
            <Cards />
            <BrandCarousel />
            <GetStarted />
